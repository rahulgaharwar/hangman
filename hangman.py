...
def display_message(message,correct_word):
    ...
    word_text = ANSWER_FONT.render(f"The word was: {correct_word}", 1, BLACK)
    win.blit(word_text, (WIDTH/2 - word_text.get_width() / 2, HEIGHT / 2 - word_text.get_height()/2 + 40))
